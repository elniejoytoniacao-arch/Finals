        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Create New Volunteer Event</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('max_volunteers') is-invalid @enderror" 
                                   id="max_volunteers" name="max_volunteers" value="{{ old('max_volunteers', 50) }}" min="1" required>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Upload a JPEG, PNG, or GIF image (max 2MB)</small>
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
